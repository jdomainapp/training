package org.jda.example.mosar.courseman.backend.services.coursemodule;

import jda.modules.mosar.backend.base.services.InheritedDomServiceAdapter;
import org.jda.example.mosar.courseman.modules.coursemodule.model.CourseModule;
...
@Service(value = "org.jda.example.mosar.courseman.backend.services.coursemodule.CourseModuleService")
public class CourseModuleService extends InheritedDomServiceAdapter<org.jda.example.mosar.courseman.modules.coursemodule.model.CourseModule> {
    ...
    @Autowired()
    public CourseModuleService(jda.mosa.software.impl.SoftwareImpl arg0, @Qualifier(value = "org.jda.example.mosar.courseman.modules.coursemodule.model.CourseModule") java.util.Map arg1) {
        super(arg0, arg1);
