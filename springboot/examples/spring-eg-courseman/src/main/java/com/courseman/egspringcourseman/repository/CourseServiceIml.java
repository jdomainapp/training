...
//    @Override
//    public List<Course> findByNameContaining(String q) {
//
//        return repository.findByNameContaining(q);
//    }

    @Override
    public List<Course> findCoursesByNamecourseContaining(String s) {
        return repository.findCoursesByNamecourseContaining(s);
    }
}
